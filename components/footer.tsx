          ...
          <div>
            ...
            <form className="flex gap-2">
              <input
                ...
                className="flex-1 h-10 px-4 rounded-lg bg-input border border-border text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent"
              />
